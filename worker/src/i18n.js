...
const STR = {
  ru: {
    ...
    reminder_offer: "🔔 Новое: мягкое ежедневное напоминание — только в дни, когда ты ещё не сделал планку. Включить?",
    btn_yes: "Да 🔔",
    btn_no: "Не сейчас",
    reminder_offer_declined: "Хорошо 🙂 Включить можно в любой момент — /remind.",
    reminder_pick: "🔔 <b>Ежедневное напоминание</b>\nГород: <b>{zone}</b> · Время: <b>{hour}:00</b>\n\nВыбери ближайший город и час (по времени этого города). В другом городе? Возьми ближайший и подвинь час под себя.",
    btn_save: "💾 Сохранить",
    btn_off: "🔕 Выключить",
    reminder_saved: "🔔 Готово! Напомню около <b>{hour}:00 ({zone})</b> в дни без планки. Выключить — /remind.",
    reminder_off_done: "🔕 Напоминания выключены. Включить снова — /remind.",
    reminder_nudge: "🧘 Время для планки! Цель на сегодня: <b>{target}</b>. Маленький шаг 💚",
    reminder_nudge_first: "🧘 Время для планки! Сегодня — твой шаг 💚",
    reminder_final: "Ставлю напоминания на паузу 🌱 Тебя не было какое-то время — без давления. Возвращайся когда захочешь: /remind.",
  },
  en: {
    ...
    reminder_offer: "🔔 New: a gentle daily reminder — only on days you haven't planked yet. Turn it on?",
    btn_yes: "Yes 🔔",
    btn_no: "Not now",
    reminder_offer_declined: "No problem 🙂 Turn it on anytime with /remind.",
    reminder_pick: "🔔 <b>Daily reminder</b>\nCity: <b>{zone}</b> · Time: <b>{hour}:00</b>\n\nPick the closest city and hour (in that city's time). In another city? Choose the nearest and nudge the hour to fit you.",
    btn_save: "💾 Save",
    btn_off: "🔕 Turn off",
    reminder_saved: "🔔 Done! I'll nudge you around <b>{hour}:00 ({zone})</b> on days you haven't planked. Turn off with /remind.",
    reminder_off_done: "🔕 Reminders off. Turn back on with /remind.",
    reminder_nudge: "🧘 Time for your plank! Today's target: <b>{target}</b>. One small step 💚",
    reminder_nudge_first: "🧘 Time for your plank! Today's your step 💚",
    reminder_final: "Pausing your reminders for now 🌱 You've been away a while — no pressure. Come back anytime: /remind.",
  },
  es: {
    ...
    reminder_offer: "🔔 Nuevo: un recordatorio diario suave — solo los días que aún no has hecho la plancha. ¿Activar?",
    btn_yes: "Sí 🔔",
    btn_no: "Ahora no",
    reminder_offer_declined: "Sin problema 🙂 Actívalo cuando quieras con /remind.",
    reminder_pick: "🔔 <b>Recordatorio diario</b>\nCiudad: <b>{zone}</b> · Hora: <b>{hour}:00</b>\n\nElige la ciudad más cercana y la hora (en la hora de esa ciudad). ¿En otra ciudad? Elige la más cercana y ajusta la hora a tu medida.",
    btn_save: "💾 Guardar",
    btn_off: "🔕 Desactivar",
    reminder_saved: "🔔 ¡Listo! Te avisaré sobre las <b>{hour}:00 ({zone})</b> los días sin plancha. Desactiva con /remind.",
    reminder_off_done: "🔕 Recordatorios desactivados. Reactiva con /remind.",
    reminder_nudge: "🧘 ¡Hora de tu plancha! Objetivo de hoy: <b>{target}</b>. Un pequeño paso 💚",
    reminder_nudge_first: "🧘 ¡Hora de tu plancha! Hoy es tu paso 💚",
    reminder_final: "Pauso tus recordatorios por ahora 🌱 Has estado ausente — sin presión. Vuelve cuando quieras: /remind.",
  },
  ar: {
    ...
    reminder_offer: "🔔 جديد: تذكير يومي لطيف — فقط في الأيام التي لم تمارس فيها البلانك بعد. هل تفعّله؟",
    btn_yes: "نعم 🔔",
    btn_no: "ليس الآن",
    reminder_offer_declined: "لا مشكلة 🙂 يمكنك تفعيله في أي وقت عبر /remind.",
    reminder_pick: "🔔 <b>تذكير يومي</b>\nالمدينة: <b>{zone}</b> · الوقت: <b>{hour}:00</b>\n\nاختر أقرب مدينة والساعة (بتوقيت تلك المدينة). في مدينة أخرى؟ اختر الأقرب واضبط الساعة بما يناسبك.",
    btn_save: "💾 حفظ",
    btn_off: "🔕 إيقاف",
    reminder_saved: "🔔 تم! سأذكّرك حوالي <b>{hour}:00 ({zone})</b> في الأيام بدون بلانك. للإيقاف: /remind.",
    reminder_off_done: "🔕 أُوقفت التذكيرات. لإعادة التفعيل: /remind.",
    reminder_nudge: "🧘 حان وقت البلانك! هدف اليوم: <b>{target}</b>. خطوة صغيرة 💚",
    reminder_nudge_first: "🧘 حان وقت البلانك! اليوم خطوتك 💚",
    reminder_final: "أوقف تذكيراتك مؤقتًا 🌱 غبت فترة — دون ضغط. عُد متى شئت: /remind.",
  },
};
